package com.dealtobook.freemarker;
...
public class CustomFreeMarkerEmailTemplateProvider implements EmailTemplateProvider {
    ...
    public void sendSmtpTestEmail(Map<String, String> config, UserModel user) throws EmailException {
        ...
        attributes.put("testNewVariable", "test new template provider");

        CustomFreeMarkerEmailTemplateProvider.EmailTemplate email = processTemplate("emailTestSubject", Collections.emptyList(), "email-test.ftl", attributes);
    ...
    public void sendExecuteActions(String link, long expirationInMinutes) throws EmailException {
        ...
        send("activationProviderAccountSubject", "executeActions.ftl", attributes);
    }
    ...
    protected CustomFreeMarkerEmailTemplateProvider.EmailTemplate processTemplate(String subjectKey, List<Object> subjectAttributes, String template, Map<String, Object> attributes) throws EmailException {
        try {
            ...
            return new CustomFreeMarkerEmailTemplateProvider.EmailTemplate(subject, textBody, htmlBody);
        } catch (Exception e) {
            throw new EmailException("Failed to template email", e);
        }
    }
    ...
    public void send(String subjectFormatKey, List<Object> subjectAttributes, String bodyTemplate, Map<String, Object> bodyAttributes) throws EmailException {
        try {
            CustomFreeMarkerEmailTemplateProvider.EmailTemplate email = processTemplate(subjectFormatKey, subjectAttributes, bodyTemplate, bodyAttributes);
